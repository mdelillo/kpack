...
type CreateBuilderArgs struct {
	...
	LifecycleImageRef string
	ClusterStack      *v1alpha1.ClusterStack
	ClusterStore      *v1alpha1.ClusterStore
	BuilderSpec       v1alpha1.BuilderSpec
}

func (f *FakeBuilderCreator) CreateBuilder(keychain authn.Keychain, lifecycleImageRef string, clusterStore *v1alpha1.ClusterStore, clusterStack *v1alpha1.ClusterStack, builder v1alpha1.BuilderSpec) (v1alpha1.BuilderRecord, error) {
	f.CreateBuilderCalls = append(f.CreateBuilderCalls, CreateBuilderArgs{
		Keychain:          keychain,
		LifecycleImageRef: lifecycleImageRef,
